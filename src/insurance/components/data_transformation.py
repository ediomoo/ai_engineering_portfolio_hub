...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            # Fixed cat_columns to cat_cols to match variable above
            ...
            # FIX: Use transformed arrays (X_train_arr) instead of raw DFs
...
if __name__ == '__main__':
    # Fixed instantiation and argument unpacking
    obj = DataTransformation()
    train_p, test_p = DataIngestion().initiate_data_ingestion()
    obj.initiate_data_transformation(train_p, test_p)
